        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown">
            ...
            <?php if (!empty($context['user']['profile_pic'])): ?>
              <img alt="image" src="<?=get_image($context['user']['profile_pic']); ?>" class="user-img-radious-style">
            <?php else: ?>
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="edituser.php?id=<?=$context['user']['id']; ?>" class="dropdown-item has-icon"> <i class="far fa-user"></i> 
                Profile
              </a>
              <a href="cars.php" class="dropdown-item has-icon"> <i class="fas fa-car"></i>
                Cars
              </a>
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            ...
            <?php if (!empty($context['company']['logo'])): ?>
              <img alt="image" src="<?=get_image($context['company']['logo']); ?>" class="header-logo" />
            <?php else: ?>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="home.php" class="nav-link"><i data-feather="home"></i><span>Home</span></a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a  href="addcar.php" class="nav-link">Add Car</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              <a href="messages.php" class="nav-link"><i data-feather="mail"></i><span>Messages</span></a>
            </li>
            <li class="dropdown">
