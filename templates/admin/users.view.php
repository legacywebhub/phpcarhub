    ...
    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4>Users List  &nbsp;&nbsp;&nbsp;<a href="adduser.php" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Add User</a></h4>
                    ...
                    <?php else: ?>
                        ...
                        <tr class="mt-2" style="margin-top: 10px !important;">
                            ...
                            <?php if($context['user']['is_superuser'] == 1): ?>
                                <a href="edituser.php?id=<?=$user['id']; ?>" class="btn btn-primary btn-action" data-toggle="tooltip" title="Edit" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                <a href="deleteuser.php?id=<?=$user['id']; ?>" class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" data-original-title="Delete"><i class="fas fa-trash"></i></a>
                            <?php else: ?>
