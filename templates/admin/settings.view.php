        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-form">
                    <a href="addsetting.php" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Add Setting</a>
                </div>
                <?php endif ?>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <?php else: ?>
                        ...
                        <tr class="mt-2" style="margin-top: 10px !important;">
                            ...
                            <td><?=$setting['email']; ?></td>
                            <td>
                            <a href="editsetting.php?id=<?=$setting['id']; ?>" class="btn btn-primary btn-action" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
