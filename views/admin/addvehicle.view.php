    ...
    <div class="card">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <!-- <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">vehicle Image <span class="text-danger">*</span></label>
            ...
            <div class="form-group row my-3">
                ...
                <div class="col-sm-12 col-md-7">
                <button name="addvehicle" class="btn btn-lg btn-primary">Submit</button>
                </div>
            </div>
        </form>
        </div>
