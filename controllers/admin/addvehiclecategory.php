...
$title = ucwords($company['name'])." | Add Vehicle Category";
...
if ($_SERVER["REQUEST_METHOD"]  == "POST" && $_POST['csrf_token'] === $_SESSION['csrf_token']) {
    ...
    try {
        $query = "INSERT INTO vehicle_categories (category) VALUES (:category)";
    ...
    redirect('addvehiclecategory', $message, $message_tag);
}
...
admin_view('addvehiclecategory', $context);